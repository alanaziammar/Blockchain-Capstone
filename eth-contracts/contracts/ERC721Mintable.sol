...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "ERC721: given address is the owner of the tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender), "ERC721: given address is neither the owner of the contract nor isApprovedForAll() is true");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_isApprovedOrOwner(msg.sender, tokenId), "ERC721: transfer caller is neither owner nor approved");
...
contract RealestateToken is ERC721Metadata("RealestateToken", "RST", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
